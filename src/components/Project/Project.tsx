    ...
    <Container id="project">
      ...
      <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3> Application web de planification scolaire</h3>
              <p>
              Html,Css,NodeJs et JavaScript
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Conception et développment d’un site Web de vente en ligne </h3>
              <p>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Analyse et Conception d un Cahier des charges - Application de gestion de tâches</h3>
              <p>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Conception et Analyse d’un site Web de cooching en linge</h3>
              <p>
              Figma
              </p>
            </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Analyse et Conception d’un site Web de reservation aux sallons des coiffeurs en ligne </h3>
              <p>
              Merise et UML et Charte de projet 
              </p>
            </div>
            <footer>
              <ul className="tech-list">
